...
class BiclCategory(models.Model):
...
class GoodsCategory(BiclCategory):
    """
    商品类别
    """
    CATEGORY_TYPE = (
    ...
    name = models.CharField(default="", max_length=50, verbose_name='类别名', help_text='类别')
    code = models.CharField(default="", max_length=50, verbose_name="类别code", help_text="类别code")
    desc = models.TextField(default="", verbose_name='类别描述', help_text='类别描述', max_length=500)
...
class GoodsCategoryBrand(BiclCategory):
    """
    品牌名
    """
    category = models.ForeignKey(GoodsCategory, null=True, blank=True, verbose_name='商品类目')
    name = models.CharField(default="", max_length=50, verbose_name='品牌名', help_text='品牌名')
    desc = models.TextField(default="", verbose_name='品牌描述', max_length=500, help_text='品牌描述')
...
class GoodsImage(BiclCategory):
    """
    商品轮播图
    """
    goods = models.ForeignKey(Goods, related_name='images', verbose_name='商品')
    image = models.ImageField(upload_to="", null=True, blank=True, max_length=200, verbose_name="图片")
